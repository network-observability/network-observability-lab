...
```bash
netobs setup deploy --scenario webinar-completed --topology ./chapters/webinar-completed/containerlab/lab.yml --vars-topology ./chapters/webinar-completed/containerlab/lab_vars.yml
```
